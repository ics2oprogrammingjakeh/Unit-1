...
-- change the transperency of the shit every time it moves so that it fades out
beetleship.alpha = beetleship.alpha + 00.1
end

-- Moveship will be calle over and over again
...
-- change the transperency of the shit every time it moves so that it fades out
octopus.alpha = beetleship.alpha + 00.1
end
